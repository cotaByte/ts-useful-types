 ...
 */
export type Enumerate<N extends number, Acc extends number[] = []> = Acc['length'] extends N ? Exclude<Acc[number] | Acc['length'], 0> : Enumerate<N, [...Acc, Acc['length']]>;
/**
 ...
 */
export type IntRange<F extends number, T extends number> = F extends T ? F : Exclude<Enumerate<T>, Enumerate<F>> extends never ? never : T | Exclude<Enumerate<T>, Enumerate<F>> | F;
/**
